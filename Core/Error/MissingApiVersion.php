...
final class MissingApiVersion extends ErrorController
{
    /**
     * Ejecuta el controlador de error para versión de API faltante.
     * Devuelve una respuesta JSON con código HTTP 400 (Bad Request).
     */
    public function run(): void
    {
        $this->response()
            ...
            ->json([
                'estado' => 'error',
                'mensaje' => $this->excepcion ? $this->excepcion->getMessage() : 'Falta especificar la versión de la API',
            ]);
    }
}