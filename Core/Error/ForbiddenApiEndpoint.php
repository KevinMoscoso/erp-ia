...
{
    /**
     * Ejecuta el controlador de error para endpoint de API prohibido.
     * Devuelve una respuesta JSON con código HTTP 403 (Forbidden).
     */
    public function run(): void
    {
        $this->response()
            ...
            ->json([
                'estado' => 'error',
                'mensaje' => $this->excepcion ? $this->excepcion->getMessage() : 'Endpoint de API prohibido',
            ]);
    }
}