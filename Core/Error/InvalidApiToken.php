...
{
    /**
     * Ejecuta el controlador de error para token de API inválido.
     * Devuelve una respuesta JSON con código HTTP 401 (Unauthorized).
     */
    public function run(): void
    {
        $this->response()
            ...
            ->json([
                'estado' => 'error',
                'mensaje' => $this->excepcion ? $this->excepcion->getMessage() : 'Token de API inválido',
            ]);
    }
}