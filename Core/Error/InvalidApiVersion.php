...
final class InvalidApiVersion extends ErrorController
{
    /**
     * Ejecuta el controlador de error para versión de API inválida.
    ...
    public function run(): void
    {
        $this->response()
            ...
            ->json([
                'estado' => 'error',
                'mensaje' => $this->excepcion ? $this->excepcion->getMessage() : 'Versión de API no válida',
            ]);
    }
}