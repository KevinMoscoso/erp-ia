...
{
    /**
     * Ejecuta el controlador de error para archivo no encontrado.
     * Establece el código HTTP 404 y muestra un mensaje de error.
     */
    public function run(): void
    {
        http_response_code(404);

        $titulo = '🔍 ' . Traduccion::obtener('archivo-no-encontrado');
