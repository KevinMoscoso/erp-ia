...
/**
 * Controlador para editar facturas de proveedores
 * 
 * Gestiona facturas de compra con funcionalidades avanzadas como generación
...
class EditFacturaProveedor extends PurchasesController
{
    ...
    protected function newRefundAction(): bool
    {
        ...
        $nuevaRectificativa = new FacturaProveedor();
        ...
        $nuevaRectificativa->numproveedor = $this->request->input('numproveedor');
